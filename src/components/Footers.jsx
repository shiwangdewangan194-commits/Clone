...
const Footers = () => {
  return (
    <div className="w-full min-h-screen md:h-screen flex flex-col md:flex-row gap-5 bg-zinc-900">
      
      {/* Left Side */}
      <div className="w-full md:w-1/2 h-auto md:h-screen flex flex-col justify-between font-founders p-8 md:p-20">
        <div>
          <h1 className="text-[12vw] md:text-[8vw] font-semibold uppercase -mb-6 md:-mb-10 leading-none tracking-wide">
            Eyes
          </h1>
          <h1 className="text-[12vw] md:text-[8vw] font-semibold uppercase -mb-6 md:-mb-10 mt-3 md:mt-5 leading-none tracking-wide">
            Opening
          </h1>
        </div>
        ...
        <svg
          ...
          className="mt-10 md:mt-0 w-20 md:w-auto"
        >
          <path
      ...
      {/* Right Side */}
      <div className="w-full md:w-1/2 flex items-center md:items-start pt-10 md:pt-0">
        <h1 className="p-8 md:p-20 font-semibold font-founders text-[9vw] md:text-[5vw] uppercase -mb-10 mt-5 leading-none tracking-wide">
          Presentations
        </h1>
      </div>
    </div>
